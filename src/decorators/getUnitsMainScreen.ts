...
export default function GetMainScreenDecorators() {
  const GetMainScreenDecorators: Array<CombineDecoratorType> = [
    Get("/mainScreen"),
  ...
  return CombineDecorators(GetMainScreenDecorators);
}
